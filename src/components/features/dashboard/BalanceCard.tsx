    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-baseline flex-wrap gap-2 sm:gap-3">
          <span className="text-xl sm:text-xl md:text-3xl lg:text-4xl font-bold tracking-tight leading-none">
            {isVisible ? formattedBalance : "••••••"}
          </span>

          <span className="text-lg sm:text-lg md:text-xl lg:text-2xl font-semibold text-gray-400 leading-none">
            {currency}
          </span>
        </div>
      </div>
